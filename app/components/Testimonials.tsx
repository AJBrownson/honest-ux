            ...
            <CarouselItem key={index} className="pl-1 basis-[80%]">
              <div className="p-1 flex">
                <div className="bg-bg flex flex-col lg:flex-row w-full lg:w-[650px] border border-stroke py-4 rounded-xl px-4 lg:px-0">
                  <div className="w-full lg:w-[32%] border-b-[1px] border-b-stroke lg:border-b-0 lg:border-r-[1px] border-r-stroke flex flex-row space-x-2 lg:space-x-0 lg:flex-col lg:items-center">
                    <Image
