...
export default function WorkspaceCarousel() {
  return (
    <>
      ...
      <div className="w-full space-x-5 inline-flex flex-nowrap overflow-hidden lg:[mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
        <div className="flex space-x-5 items-center justify-center md:justify-start [&_li]:mx-1 lg:[&_li]:mx-2 [&_img]:max-w-none animate-infinite-scroll">
          <div className="border border-[#474853] bg-[#0D0D0D] rounded-xl p-2">
            <Image
              src={Rectangle}
              alt=""
